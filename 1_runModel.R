...
print(paste("meanSPRUCEshare =", 100*sum(ops[[1]]$spruce*ops[[1]]$N)/(sum(ops[[1]]$birch*ops[[1]]$N)+sum(ops[[1]]$spruce*ops[[1]]$N)+sum(ops[[1]]$pine*ops[[1]]$N)+sum(ops[[1]]$decid*ops[[1]]$N))))
print(paste("meanPINEshare =", 100*sum(ops[[1]]$pine*ops[[1]]$N)/(sum(ops[[1]]$birch*ops[[1]]$N)+sum(ops[[1]]$spruce*ops[[1]]$N)+sum(ops[[1]]$pine*ops[[1]]$N)+sum(ops[[1]]$decid*ops[[1]]$N))))
print(paste("meanBIRCHshare =", 100*sum(ops[[1]]$birch*ops[[1]]$N)/(sum(ops[[1]]$birch*ops[[1]]$N)+sum(ops[[1]]$spruce*ops[[1]]$N)+sum(ops[[1]]$pine*ops[[1]]$N)+sum(ops[[1]]$decid*ops[[1]]$N))))
print(paste("meanDECIDshare =", 100*sum(ops[[1]]$decid*ops[[1]]$N)/(sum(ops[[1]]$birch*ops[[1]]$N)+sum(ops[[1]]$spruce*ops[[1]]$N)+sum(ops[[1]]$pine*ops[[1]]$N)+sum(ops[[1]]$decid*ops[[1]]$N))))
